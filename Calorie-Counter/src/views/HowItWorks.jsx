    ...
    <section className="bg-[#FFF4CA]/30 py-24 px-6 relative overflow-hidden">
      ...
      <div className="max-w-5xl mx-auto grid grid-cols-1 lg:grid-cols-12 gap-8 items-center relative z-10">
        ...
        <div className="lg:col-span-4 flex flex-col gap-6 items-center lg:items-end order-2 lg:order-1">
          <div className={`${steps[0].bg} font-black text-xs px-5 py-3 rounded-full shadow-lg flex items-center gap-2 transform hover:scale-105 transition-all duration-300`}>
            <span>{steps[0].num} —</span> <span>{steps[0].label}</span>
          </div>
          <div className={`${steps[2].bg} font-black text-xs px-5 py-3 rounded-full shadow-lg flex items-center gap-2 transform hover:scale-105 transition-all duration-300`}>
        ...
        <div className="lg:col-span-4 flex justify-center order-1 lg:order-2">
          <div className="w-72 aspect-[4/5] rounded-[3rem] overflow-hidden shadow-2xl bg-white border border-gray-100 p-4">
        ...
        <div className="lg:col-span-4 flex flex-col gap-6 items-center lg:items-start order-3">
          <div className={`${steps[1].bg} font-black text-xs px-5 py-3 rounded-full shadow-lg flex items-center gap-2 transform hover:scale-105 transition-all duration-300`}>
            <span>{steps[1].num} —</span> <span>{steps[1].label}</span>
          </div>
          <div className={`${steps[3].bg} font-black text-xs px-5 py-3 rounded-full shadow-lg flex items-center gap-2 transform hover:scale-105 transition-all duration-300`}>
            <span>{steps[3].num} —</span> <span>{steps[3].label}</span>
          </div>
          <div className={`${steps[4].bg} font-black text-xs px-5 py-3 rounded-full shadow-lg flex items-center gap-2 transform hover:scale-105 transition-all duration-300`}>
