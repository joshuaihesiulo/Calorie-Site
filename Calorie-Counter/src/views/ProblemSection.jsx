    ...
    <section className="bg-white px-6 py-20 border-t border-gray-50">
      <div className="max-w-6xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
        ...
        <div>
          ...
          <h2 className="text-4xl md:text-5xl font-black text-[#2C3768] tracking-tighter mt-4 mb-6 leading-none">
        ...
        <div className="flex flex-col gap-6 lg:mt-16">
          <div className="bg-[#00F090]/10 border border-[#00F090]/30 p-8 rounded-[2rem] hover:scale-[1.01] transition-transform duration-300">
          ...
          <div className="bg-[#FFF4CA]/40 border border-[#FFF4CA]/80 p-8 rounded-[2rem] hover:scale-[1.01] transition-transform duration-300">
